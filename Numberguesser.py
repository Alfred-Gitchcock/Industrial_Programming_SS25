...
print("Congratulations! You have been selected as a test subject for our number guessing testing initiative. "
      ...
      "The Game works as follows: You have to compete against our highly advanced number guessing AI in guessing a randomly selected integer between 1 and 10. \n"
...
while player_guess != random_number and ai_guess != random_number:
      ...
      #"AI"'s turn
      ai_guess = np.random.randint(1,10)
